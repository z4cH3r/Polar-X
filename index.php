    ...
    <div class="team-boxed" style="background-color:'.$bg_color.'">
        ...
        foreach ($staff as $steamid64 => $role) {
            ...
            <div class="box"><img class="rounded-circle" src="'.$json["response"]["players"][0]["avatarfull"].'">
                ...
                <p class="title" style="color:rgb(49,52,55);">'.$role.'</p><a href="https://steamcommunity.com/profiles/'.$json["response"]["players"][0]["steamid"].'" target="_blank"><button class="btn btn-outline-primary" type="button">STEAM</button></a></div>
            </div>';
        }
        echo '</div>
        </div>
